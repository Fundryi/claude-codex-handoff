...
- The feed shows everything; there is no filter or "Show internals" switch. Its grammar:
  ...
  - A Codex reply with a real question under Needs decision gets an "asks you" tag, and the whole Needs decision section (never cut short, sub-headed options included, up to the next heading of the same or a higher level, a bold heading counting as ##, or one of the four return-format headings; headings inside code fences do not count) moves out of the text into a pink "Question for you" callout at the end of the card.
