...
description: Internal guidance for composing Codex prompts (GPT-5.4 through GPT-6 Astra) for coding, review, diagnosis, and research tasks inside the Codex Claude Code plugin
user-invocable: false
---

# Codex Prompting

Use this skill when `codex:codex-rescue` needs to ask Codex for help. The guidance was written against GPT-5.4 and applies to GPT-6 Astra and the GPT-5.6 models (sol, terra, luna).
