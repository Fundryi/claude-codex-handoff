...
argument-hint: "[--background] [--resume|--fresh] [--model <model|sol|terra|luna|daybreak-blue|spark>] [--effort <low|medium|high|xhigh|max|ultra>] [what Codex should investigate, solve, or continue]"
