...
function parseStopReviewOutput(rawOutput) {
  ...
  if (!text) {
    return {
      ok: false,
      reason:
        "The stop-time Codex review task returned no final output. Run /codex:review manually or bypass the gate."
    };
  }
  ...
  return {
    ok: false,
    reason:
      "The stop-time Codex review task returned an unexpected answer. Run /codex:review manually or bypass the gate."
  };
}
  ...
  if (result.status !== 0) {
    ...
    return {
      ...
      reason: detail
        ...
        : "The stop-time Codex review task failed. Run /codex:review manually or bypass the gate."
    };
  }
